...
const InvestHistory = async (req, res) => {
  try {
    ...
    const buy_funds = await BuyFund.findAll({
      ...
      attributes: ['created_at', 'amount', 'status', 'type', 'txn_no'], // Specify the fields you want to fetch
...
module.exports = { levelTeam, direcTeam, fetchwallet, dynamicUpiCallback, available_balance, withfatch, withreq, sendotp, processWithdrawal, fetchserver, submitserver, getAvailableBalance, fetchrenew, renewserver, fetchservers, InvestHistory, withdrawHistory, ChangePassword,saveWalletAddress,getUserDetails };